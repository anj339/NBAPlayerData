...
print("Mean Sqaure for Rebounds")
print()
print(mse_rebounds)
print()
print()
...
print("Mean Sqaure for Team Performance")
print()
print(mse_team_points)
print()
print()

# 3. Player Longevity
# Define a long career as playing more than 500 minutes in the playoffs
# Assuming 'Minutes Played' is a proxy for career length
long_career = df['Minutes_Per_Game'] > 500
...
plt.scatter(y_test, pred_points)
...
# Assists Prediction
plt.figure(figsize=(10, 6))
plt.scatter(y_test, pred_assists)
...
# Rebounds Prediction
plt.figure(figsize=(10, 6))
plt.scatter(y_test, pred_rebounds)
plt.xlabel('Actual Rebounds')
plt.ylabel('Predicted Rebounds')
plt.title('Actual vs Predicted Rebounds')
plt.show()

# Residuals for points prediction
residuals_points = y_test - pred_points

# Residual plot
plt.figure(figsize=(10, 6))
plt.scatter(pred_points, residuals_points)
plt.axhline(y=0, color='r', linestyle='--')
plt.xlabel('Predicted Points')
plt.ylabel('Residuals')
plt.title('Residual Analysis for Points Prediction')
plt.show()


# Histogram of residuals
plt.figure(figsize=(10, 6))
sns.histplot(residuals_points, kde=True)
plt.xlabel('Residuals')
plt.title('Histogram of Residuals for Points Prediction')
plt.show()

# Q-Q plot
import scipy.stats as stats
plt.figure(figsize=(10, 6))
stats.probplot(residuals_points, dist="norm", plot=plt)
plt.title('Q-Q Plot of Residuals for Points Prediction')
plt.show()
